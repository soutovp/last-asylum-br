    ...
    <>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch justify-center">
          {guides.map((item) => {
            // Usa webp_url ou image_url e garante que, se for do Cloudinary, use a reescrita WebP otimizada mesmo em cadastros antigos
            let previewImageUrl = item.webp_url || item.image_url;
            if (previewImageUrl.includes("cloudinary.com")) {
