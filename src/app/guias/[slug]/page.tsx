          ...
          <article className="bg-[#101623]/95 border border-slate-800 rounded-3xl p-6 sm:p-10 backdrop-blur-xl shadow-2xl space-y-8">
            <header className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800/80 pb-4">
                <Link
                  href="/guias"
                  className="text-xs font-mono font-bold text-cyan-400 hover:text-cyan-300 transition-colors inline-flex items-center gap-1.5 w-fit"
                >
                  <span>←</span> <span>Base de Guias</span>
                </Link>
                <div className="flex flex-wrap items-center gap-2">
                  <span className="px-3 py-1 rounded-full text-xs font-semibold bg-cyan-500/10 text-cyan-400 border border-cyan-500/30 inline-flex items-center gap-1.5 shadow-sm">
                    <span>🏷️</span>
                    <span>{article.category || "Guias"}</span>
                  </span>
